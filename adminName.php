...
<html lang="en-US">
    ...
    <body>
                        ...
                        <div  class="formAdmin">
                            <form role="form"  method="post" id="adminLogin" enctype='multipart/form-data'>
                                <fieldset>
                                    ...
                                    <button name="chat_form" id="adminBtn" data-role="none">Get Chat.</button>

                                </fieldset>
                            </form>
                        </div>
                    
                        <?php include 'php/phpChat/adminName.php'; ?>
            </section>  
        ...
        <script type="text/javascript" src="jscss/js/jsChat/admin.js"></script>
    </body>
</html>
